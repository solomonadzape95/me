     ...
     <div className="flex items-end justify-between mb-6">
      ...
      <article>
        <ReactMarkdown
          ...
          components={{
            h1: ({children}) => <h1 className="text-3xl lg:text-4xl font-mono mt-10 mb-4">{children}</h1>,
            h2: ({children}) => <h2 className="text-2xl lg:text-3xl font-mono mt-8 mb-3">{children}</h2>,
            h3: ({children}) => <h3 className="text-xl lg:text-2xl font-mono mt-6 mb-2">{children}</h3>,
