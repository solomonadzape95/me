    ...
    <div className="font-mono w-11/12 mx-auto mt-14">
      <section>
        <section className="flex items-start flex-col-reverse lg:flex-row gap-2">
          ...
          <p className="text-md lg:text-xl lg:w-10/12 leading-relaxed mb-8">I'm a student, and I build stuff. My interests are computer science, tech, engineering and sports. I (currently) focus on frontend development and enjoy working with AI tools, data, and the blockchain. I'm excited to understand how things work so I enjoy planning out and building scalable systems. I enjoy solving puzzles and tackling complex problems.</p>
          <QuickLinksHome />
          <QuickJobsHome />
          </section>
        <WindowComponent/>
